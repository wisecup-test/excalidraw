...
1. SHOULD: Modules performing JSON operations SHOULD import validation utilities from @excalidraw/excalidraw/data/json or equivalent validation libraries

## Policy Block

- SHOULD Modules performing JSON operations SHOULD import validation utilities from @excalidraw/excalidraw/data/json or equivalent validation libraries
