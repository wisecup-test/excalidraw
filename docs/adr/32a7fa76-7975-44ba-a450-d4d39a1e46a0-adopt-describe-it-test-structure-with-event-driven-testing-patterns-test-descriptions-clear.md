...
1. MUST: Test descriptions MUST be clear and descriptive, explaining what behavior is being tested (e.g., 'should emit two ephemeral increments even though updates get batched')

## Policy Block

- MUST Test descriptions MUST be clear and descriptive, explaining what behavior is being tested (e.g., 'should emit two ephemeral increments even though updates get batched')
