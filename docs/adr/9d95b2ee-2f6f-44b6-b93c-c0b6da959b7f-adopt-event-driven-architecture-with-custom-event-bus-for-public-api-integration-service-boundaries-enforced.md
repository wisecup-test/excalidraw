...
1. SHOULD: Service boundaries SHOULD be enforced through getter methods (this.emitters.get, this.lastPayload.get, this.broadcastedElementVersions.get, this.collaborators.get) rather than direct property access

## Policy Block

- SHOULD Service boundaries SHOULD be enforced through getter methods (this.emitters.get, this.lastPayload.get, this.broadcastedElementVersions.get, this.collaborators.get) rather than direct property access
