...
1. SHOULD: Services SHOULD check state atoms before performing operations that may fail due to quota or capacity constraints

## Policy Block

- SHOULD Services SHOULD check state atoms before performing operations that may fail due to quota or capacity constraints
