...
1. MAY: Applications MAY use IndexedDB (idb-keyval) as a fallback storage layer when localStorage quota is exceeded

## Policy Block

- MAY Applications MAY use IndexedDB (idb-keyval) as a fallback storage layer when localStorage quota is exceeded
