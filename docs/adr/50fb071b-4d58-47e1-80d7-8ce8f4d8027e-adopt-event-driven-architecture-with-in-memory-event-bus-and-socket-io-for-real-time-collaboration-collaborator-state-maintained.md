...
1. SHOULD: Collaborator state SHOULD be maintained in Map-based structures (e.g., this.collaborators.get(socketId)) to enable O(1) lookup and updates

## Policy Block

- SHOULD Collaborator state SHOULD be maintained in Map-based structures (e.g., this.collaborators.get(socketId)) to enable O(1) lookup and updates
