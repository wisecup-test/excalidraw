...
1. MAY: Tests MAY use Promise-based subscribers in addition to callback-based subscribers to verify event bus behavior with different subscription patterns

## Policy Block

- MAY Tests MAY use Promise-based subscribers in addition to callback-based subscribers to verify event bus behavior with different subscription patterns
