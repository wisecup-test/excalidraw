...
1. SHOULD: Debug and development information SHOULD be logged using console.info to distinguish informational messages from errors and warnings

## Policy Block

- SHOULD Debug and development information SHOULD be logged using console.info to distinguish informational messages from errors and warnings
