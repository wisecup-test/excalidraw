...
1. MUST: Cache keys MUST be strongly typed and semantically meaningful (e.g., element IDs, socket IDs, file IDs, color values)

## Policy Block

- MUST Cache keys MUST be strongly typed and semantically meaningful (e.g., element IDs, socket IDs, file IDs, color values)
