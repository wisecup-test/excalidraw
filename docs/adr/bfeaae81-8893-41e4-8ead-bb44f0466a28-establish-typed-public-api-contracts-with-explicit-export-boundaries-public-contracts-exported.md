...
1. MUST: Public API contracts MUST be exported as named types (interfaces, type aliases, or classes) that consumers can import and reference

## Policy Block

- MUST Public API contracts MUST be exported as named types (interfaces, type aliases, or classes) that consumers can import and reference
