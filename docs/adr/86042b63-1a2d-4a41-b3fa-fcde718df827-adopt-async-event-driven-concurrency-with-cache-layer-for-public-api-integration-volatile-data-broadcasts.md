...
1. SHOULD: Volatile data broadcasts SHOULD be distinguished from persistent broadcasts using explicit event type parameters (WS_EVENTS.SERVER_VOLATILE vs WS_EVENTS.SERVER)

## Policy Block

- SHOULD Volatile data broadcasts SHOULD be distinguished from persistent broadcasts using explicit event type parameters (WS_EVENTS.SERVER_VOLATILE vs WS_EVENTS.SERVER)
