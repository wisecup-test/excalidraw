...
1. MAY: Public APIs MAY include performance logging using console.info for operations that track timing, frame budgets, or resource usage

## Policy Block

- MAY Public APIs MAY include performance logging using console.info for operations that track timing, frame budgets, or resource usage
