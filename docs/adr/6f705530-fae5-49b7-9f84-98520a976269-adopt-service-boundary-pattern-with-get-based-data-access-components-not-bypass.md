...
1. MUST_NOT: Components MUST NOT bypass service boundaries by directly accessing underlying data structures (Maps, stores, caches) except within the service implementation itself

## Policy Block

- MUST_NOT Components MUST NOT bypass service boundaries by directly accessing underlying data structures (Maps, stores, caches) except within the service implementation itself
