...
1. MUST_NOT: Public API contracts MUST NOT expose implementation-specific types or structures that would create tight coupling to internal architecture

## Policy Block

- MUST_NOT Public API contracts MUST NOT expose implementation-specific types or structures that would create tight coupling to internal architecture
