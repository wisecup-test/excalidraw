...
1. SHOULD: JSON.parse operations on configuration data SHOULD log at console.warn level to distinguish from runtime errors

## Policy Block

- SHOULD JSON.parse operations on configuration data SHOULD log at console.warn level to distinguish from runtime errors
