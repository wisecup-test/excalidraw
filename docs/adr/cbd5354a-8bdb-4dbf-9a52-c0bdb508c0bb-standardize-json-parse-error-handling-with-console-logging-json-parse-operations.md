...
1. SHOULD: JSON.parse operations on untrusted input (localStorage, external APIs, user-provided data) SHOULD log at console.error level

## Policy Block

- SHOULD JSON.parse operations on untrusted input (localStorage, external APIs, user-provided data) SHOULD log at console.error level
