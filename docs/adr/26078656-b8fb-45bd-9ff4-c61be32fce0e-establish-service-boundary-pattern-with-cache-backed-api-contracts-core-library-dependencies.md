...
1. MUST: Core library dependencies MUST be explicitly declared in import statements and isolated to specific service boundaries to prevent unintended coupling

## Policy Block

- MUST Core library dependencies MUST be explicitly declared in import statements and isolated to specific service boundaries to prevent unintended coupling
