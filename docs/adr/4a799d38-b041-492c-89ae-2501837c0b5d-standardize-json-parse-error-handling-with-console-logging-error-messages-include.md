...
1. SHOULD: Error messages SHOULD include sufficient context to identify the module and operation where parsing failed

## Policy Block

- SHOULD Error messages SHOULD include sufficient context to identify the module and operation where parsing failed
