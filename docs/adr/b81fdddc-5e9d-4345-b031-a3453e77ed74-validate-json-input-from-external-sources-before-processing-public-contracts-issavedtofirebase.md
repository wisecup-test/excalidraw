...
1. SHOULD: Public API contracts (isSavedToFirebase, loadFromFirebase, importFromLocalStorage, etc.) SHOULD document expected JSON schemas and validation requirements

## Policy Block

- SHOULD Public API contracts (isSavedToFirebase, loadFromFirebase, importFromLocalStorage, etc.) SHOULD document expected JSON schemas and validation requirements
