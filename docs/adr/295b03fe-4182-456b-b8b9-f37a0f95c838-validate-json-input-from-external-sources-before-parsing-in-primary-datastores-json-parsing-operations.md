...
1. SHOULD: JSON parsing operations in datastore integration code SHOULD validate the structure of parsed objects before using them in transactions (transaction.set, cache.set, filesMap.set)

## Policy Block

- SHOULD JSON parsing operations in datastore integration code SHOULD validate the structure of parsed objects before using them in transactions (transaction.set, cache.set, filesMap.set)
