...
1. SHOULD: Test files SHOULD import from shared test utilities (@excalidraw/excalidraw/tests/helpers/ui, @excalidraw/excalidraw/tests/test-utils) rather than duplicating test infrastructure

## Policy Block

- SHOULD Test files SHOULD import from shared test utilities (@excalidraw/excalidraw/tests/helpers/ui, @excalidraw/excalidraw/tests/test-utils) rather than duplicating test infrastructure
