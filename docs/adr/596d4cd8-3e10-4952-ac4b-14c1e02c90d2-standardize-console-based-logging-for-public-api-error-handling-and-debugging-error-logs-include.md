...
1. MUST: Error logs MUST include contextual information such as the operation being performed, relevant identifiers, and the error object or message

## Policy Block

- MUST Error logs MUST include contextual information such as the operation being performed, relevant identifiers, and the error object or message
