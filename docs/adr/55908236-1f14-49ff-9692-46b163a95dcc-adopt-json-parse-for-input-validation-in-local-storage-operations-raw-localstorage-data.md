...
1. MUST_NOT: Raw localStorage data MUST_NOT be used directly without JSON.parse validation

## Policy Block

- MUST_NOT Raw localStorage data MUST_NOT be used directly without JSON.parse validation
