...
1. SHOULD: Parsed JSON objects SHOULD be validated against expected schema or structure before use in application logic

## Policy Block

- SHOULD Parsed JSON objects SHOULD be validated against expected schema or structure before use in application logic
