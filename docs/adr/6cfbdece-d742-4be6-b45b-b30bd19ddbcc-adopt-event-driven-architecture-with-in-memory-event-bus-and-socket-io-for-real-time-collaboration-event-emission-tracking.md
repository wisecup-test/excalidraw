...
1. SHOULD: Event emission tracking SHOULD use Set-based structures (e.g., this.emittedOnce.add(name)) to prevent duplicate processing of one-time events

## Policy Block

- SHOULD Event emission tracking SHOULD use Set-based structures (e.g., this.emittedOnce.add(name)) to prevent duplicate processing of one-time events
