...
1. MUST: Last event payloads MUST be cached (e.g., this.lastPayload.get(name), this.lastPayload.set(name, args)) to support late-joining subscribers with replay-on-subscribe behavior

## Policy Block

- MUST Last event payloads MUST be cached (e.g., this.lastPayload.get(name), this.lastPayload.set(name, args)) to support late-joining subscribers with replay-on-subscribe behavior
