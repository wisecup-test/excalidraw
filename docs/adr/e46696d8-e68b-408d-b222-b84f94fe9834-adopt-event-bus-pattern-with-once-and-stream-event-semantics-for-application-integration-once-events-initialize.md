...
1. MUST: Once events (e.g., 'initialize') MUST be replayed to callbacks and Promise subscribers that register after the event has been emitted

## Policy Block

- MUST Once events (e.g., 'initialize') MUST be replayed to callbacks and Promise subscribers that register after the event has been emitted
