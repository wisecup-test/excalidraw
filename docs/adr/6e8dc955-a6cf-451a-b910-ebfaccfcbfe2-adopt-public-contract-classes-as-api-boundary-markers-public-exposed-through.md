...
1. MUST: Public APIs MUST be exposed through dedicated contract classes that serve as explicit boundary markers (e.g., Portal, LocalData, TTDIndexedDBAdapter)

## Policy Block

- MUST Public APIs MUST be exposed through dedicated contract classes that serve as explicit boundary markers (e.g., Portal, LocalData, TTDIndexedDBAdapter)
