...
1. MUST: Event bus implementations MUST provide both .on() callback registration and Promise-based subscription mechanisms

## Policy Block

- MUST Event bus implementations MUST provide both .on() callback registration and Promise-based subscription mechanisms
