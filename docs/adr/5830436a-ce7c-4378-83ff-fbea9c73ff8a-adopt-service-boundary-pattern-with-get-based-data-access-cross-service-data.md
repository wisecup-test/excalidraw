...
1. MUST: All cross-service data access MUST use explicit get-based accessor methods (e.g., cache.get(), store.get(), transaction.get()) rather than direct property access

## Policy Block

- MUST All cross-service data access MUST use explicit get-based accessor methods (e.g., cache.get(), store.get(), transaction.get()) rather than direct property access
