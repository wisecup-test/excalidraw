...
1. MUST: Service boundaries MUST expose public contracts through dedicated classes (Portal, LocalData) that encapsulate internal implementation details

## Policy Block

- MUST Service boundaries MUST expose public contracts through dedicated classes (Portal, LocalData) that encapsulate internal implementation details
