...
1. SHOULD: Event-driven tests SHOULD distinguish between durable and ephemeral events/increments when testing state management

## Policy Block

- SHOULD Event-driven tests SHOULD distinguish between durable and ephemeral events/increments when testing state management
