...
1. MUST: Event-driven communication MUST use the custom AppEventBus and Emitter abstractions with typed event handlers (on, emit) rather than direct socket manipulation

## Policy Block

- MUST Event-driven communication MUST use the custom AppEventBus and Emitter abstractions with typed event handlers (on, emit) rather than direct socket manipulation
