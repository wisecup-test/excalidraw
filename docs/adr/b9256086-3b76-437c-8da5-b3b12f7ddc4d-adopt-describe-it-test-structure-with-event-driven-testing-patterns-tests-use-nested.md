...
1. MAY: Tests MAY use nested describe blocks to group related test cases within a feature domain

## Policy Block

- MAY Tests MAY use nested describe blocks to group related test cases within a feature domain
