...
1. MUST: State management MUST use Jotai atoms (e.g., appJotaiStore with atoms like localStorageQuotaExceededAtom) for reactive state coordination across components

## Policy Block

- MUST State management MUST use Jotai atoms (e.g., appJotaiStore with atoms like localStorageQuotaExceededAtom) for reactive state coordination across components
