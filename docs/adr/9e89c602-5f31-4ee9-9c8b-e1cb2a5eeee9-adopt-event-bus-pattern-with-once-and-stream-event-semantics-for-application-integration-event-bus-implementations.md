...
1. MUST: Event bus implementations MUST support two distinct event types: once events that replay to late subscribers and stream events that do not replay

## Policy Block

- MUST Event bus implementations MUST support two distinct event types: once events that replay to late subscribers and stream events that do not replay
