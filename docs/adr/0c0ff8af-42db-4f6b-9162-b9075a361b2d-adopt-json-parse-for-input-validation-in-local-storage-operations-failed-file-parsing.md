...
1. SHOULD: Failed file parsing operations SHOULD update the erroredFiles map to track problematic data

## Policy Block

- SHOULD Failed file parsing operations SHOULD update the erroredFiles map to track problematic data
