...
1. MUST: All cache operations for collaborative scene data MUST use dedicated cache abstractions (FirebaseSceneVersionCache.cache, appJotaiStore, filesMap) rather than direct storage access

## Policy Block

- MUST All cache operations for collaborative scene data MUST use dedicated cache abstractions (FirebaseSceneVersionCache.cache, appJotaiStore, filesMap) rather than direct storage access
