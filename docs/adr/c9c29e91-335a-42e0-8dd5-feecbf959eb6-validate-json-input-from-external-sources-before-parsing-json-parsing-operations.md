...
1. SHOULD: JSON parsing operations on encrypted or encoded data SHOULD verify data integrity before attempting to parse

## Policy Block

- SHOULD JSON parsing operations on encrypted or encoded data SHOULD verify data integrity before attempting to parse
