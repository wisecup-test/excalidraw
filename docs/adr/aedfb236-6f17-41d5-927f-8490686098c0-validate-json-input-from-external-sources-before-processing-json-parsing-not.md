...
1. MUST_NOT: JSON parsing MUST NOT be performed on raw external input without error handling, even for data from seemingly trusted sources like localStorage

## Policy Block

- MUST_NOT JSON parsing MUST NOT be performed on raw external input without error handling, even for data from seemingly trusted sources like localStorage
