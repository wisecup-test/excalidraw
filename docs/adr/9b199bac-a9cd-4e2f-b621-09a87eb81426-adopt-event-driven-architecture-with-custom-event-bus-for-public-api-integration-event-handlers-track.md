# Adopt Event-Driven Architecture with Custom Event Bus for Public API Integration: Event Handlers Track
...
1. SHOULD: Event handlers SHOULD track emission state (this.emittedOnce.add) to support replay-on-subscribe patterns for late-joining subscribers

## Policy Block

- SHOULD Event handlers SHOULD track emission state (this.emittedOnce.add) to support replay-on-subscribe patterns for late-joining subscribers
