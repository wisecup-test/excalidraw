...
1. MUST: Store increment emitters MUST distinguish between durable increments and ephemeral increments through type checking (e.g., StoreIncrement.isDurable)

## Policy Block

- MUST Store increment emitters MUST distinguish between durable increments and ephemeral increments through type checking (e.g., StoreIncrement.isDurable)
