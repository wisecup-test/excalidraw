...
1. MUST: Services MUST implement cache access through get(), set(), and delete() operations on Map instances

## Policy Block

- MUST Services MUST implement cache access through get(), set(), and delete() operations on Map instances
