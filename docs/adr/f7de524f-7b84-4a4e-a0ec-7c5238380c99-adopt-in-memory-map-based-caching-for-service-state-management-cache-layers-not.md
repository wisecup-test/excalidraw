...
1. MUST_NOT: Cache layers MUST NOT be used for persistent data that requires durability guarantees across application restarts

## Policy Block

- MUST_NOT Cache layers MUST NOT be used for persistent data that requires durability guarantees across application restarts
