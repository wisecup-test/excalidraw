...
1. SHOULD: Event-driven components SHOULD expose public contracts (e.g., AppEventBus, AppEventPayloadMap, Portal, CollabAPI) to define clear boundaries between services

## Policy Block

- SHOULD Event-driven components SHOULD expose public contracts (e.g., AppEventBus, AppEventPayloadMap, Portal, CollabAPI) to define clear boundaries between services
