...
1. MUST: Event bus implementations MUST use Map-based cache structures to store emitter instances keyed by event name (e.g., this.emitters.get(name), this.emitters.set(name, emitter))

## Policy Block

- MUST Event bus implementations MUST use Map-based cache structures to store emitter instances keyed by event name (e.g., this.emitters.get(name), this.emitters.set(name, emitter))
