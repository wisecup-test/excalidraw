...
1. MUST: All socket-based communication operations MUST use event-driven patterns with non-blocking handlers (socket.on, socket.emit) for real-time collaboration features

## Policy Block

- MUST All socket-based communication operations MUST use event-driven patterns with non-blocking handlers (socket.on, socket.emit) for real-time collaboration features
