...
1. SHOULD: Error messages SHOULD include the raw input value (truncated if necessary) to aid debugging while avoiding sensitive data exposure

## Policy Block

- SHOULD Error messages SHOULD include the raw input value (truncated if necessary) to aid debugging while avoiding sensitive data exposure
