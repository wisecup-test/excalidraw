...
1. MAY: API contracts MAY include utility types and helper interfaces that facilitate common usage patterns without exposing implementation

## Policy Block

- MAY API contracts MAY include utility types and helper interfaces that facilitate common usage patterns without exposing implementation
