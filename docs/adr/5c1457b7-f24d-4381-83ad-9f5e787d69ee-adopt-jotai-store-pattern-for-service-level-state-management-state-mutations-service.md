...
1. SHOULD: State mutations in service boundaries SHOULD be atomic operations using the store's set() method

## Policy Block

- SHOULD State mutations in service boundaries SHOULD be atomic operations using the store's set() method
