...
1. SHOULD: Cache implementations SHOULD check for existence using get() before performing operations to avoid undefined behavior

## Policy Block

- SHOULD Cache implementations SHOULD check for existence using get() before performing operations to avoid undefined behavior
