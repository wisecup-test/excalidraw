...
1. SHOULD: API contracts SHOULD use descriptive, domain-specific names that clearly communicate their purpose and scope (e.g., ColorPaletteCustom, ColorShadesIndexes, AppEventPayloadMap)

## Policy Block

- SHOULD API contracts SHOULD use descriptive, domain-specific names that clearly communicate their purpose and scope (e.g., ColorPaletteCustom, ColorShadesIndexes, AppEventPayloadMap)
