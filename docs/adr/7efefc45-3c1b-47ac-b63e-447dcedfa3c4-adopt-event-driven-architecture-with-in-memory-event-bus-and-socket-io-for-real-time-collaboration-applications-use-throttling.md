...
1. MAY: Applications MAY use throttling (e.g., lodash.throttle) on high-frequency event broadcasts to reduce network congestion

## Policy Block

- MAY Applications MAY use throttling (e.g., lodash.throttle) on high-frequency event broadcasts to reduce network congestion
