...
1. SHOULD: Cache layers SHOULD be scoped to specific data domains (scene versions, file data, application state) to maintain separation of concerns

## Policy Block

- SHOULD Cache layers SHOULD be scoped to specific data domains (scene versions, file data, application state) to maintain separation of concerns
