...
1. MUST: Test suites MUST validate both replay behavior for once events and non-replay behavior for stream events

## Policy Block

- MUST Test suites MUST validate both replay behavior for once events and non-replay behavior for stream events
