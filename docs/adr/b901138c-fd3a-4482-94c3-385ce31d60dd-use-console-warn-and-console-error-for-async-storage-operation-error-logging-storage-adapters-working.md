...
1. SHOULD: Storage adapters working with idb-keyval SHOULD log failures during set() and get() operations

## Policy Block

- SHOULD Storage adapters working with idb-keyval SHOULD log failures during set() and get() operations
