...
1. SHOULD: Decrypted data that will be JSON-parsed SHOULD be validated to ensure decryption succeeded before parsing

## Policy Block

- SHOULD Decrypted data that will be JSON-parsed SHOULD be validated to ensure decryption succeeded before parsing
