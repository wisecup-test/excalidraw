...
1. MUST: Services MUST define explicit public API contracts using TypeScript types or interfaces that declare all externally accessible functions, types, and constants

## Policy Block

- MUST Services MUST define explicit public API contracts using TypeScript types or interfaces that declare all externally accessible functions, types, and constants
