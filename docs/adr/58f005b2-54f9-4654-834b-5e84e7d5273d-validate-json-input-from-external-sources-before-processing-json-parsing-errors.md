...
1. MUST: JSON parsing errors MUST be logged using console.error or console.warn with sufficient context to identify the source and nature of the invalid data

## Policy Block

- MUST JSON parsing errors MUST be logged using console.error or console.warn with sufficient context to identify the source and nature of the invalid data
