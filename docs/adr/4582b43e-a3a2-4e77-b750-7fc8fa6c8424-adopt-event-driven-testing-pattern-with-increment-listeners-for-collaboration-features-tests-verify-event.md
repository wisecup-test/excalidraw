...
1. MUST: Tests MUST verify event replay behavior by registering late subscribers after events have been emitted and asserting on the received events

## Policy Block

- MUST Tests MUST verify event replay behavior by registering late subscribers after events have been emitted and asserting on the received events
