...
1. MUST: WebSocket event handlers MUST be registered using socket.on() for bidirectional events including 'init-room', 'new-user', 'room-user-change', 'client-broadcast', 'first-in-room', and 'USER_FOLLOW_ROOM_CHANGE'

## Policy Block

- MUST WebSocket event handlers MUST be registered using socket.on() for bidirectional events including 'init-room', 'new-user', 'room-user-change', 'client-broadcast', 'first-in-room', and 'USER_FOLLOW_ROOM_CHANGE'
