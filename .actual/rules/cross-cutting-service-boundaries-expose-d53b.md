# Adopt Event-Driven Service Boundaries with Versioned Cache Synchronization: Service Boundaries Expose
...
- **R-SB-001** MUST: Service boundaries MUST expose public contracts through dedicated classes (Portal, LocalData) that encapsulate internal implementation details.
...
<enforcement>
Claude Code MUST NOT skip or defer verification. All four verification conditions must pass before accepting changes to service boundary implementations.
</enforcement>