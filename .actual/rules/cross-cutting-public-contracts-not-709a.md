# Establish Typed Public API Contracts with Explicit Export Boundaries: Public Contracts Not
...
- **R-API-001** MUST NOT: Public API contracts MUST NOT expose implementation-specific types or structures that would create tight coupling to internal architecture.
...
# Check for public API contract markers
...
<enforcement>
Claude Code MUST NOT skip or defer verification. TypeScript strict mode compilation MUST pass in CI. Code review MUST confirm proper API boundary definition for new services. Pull requests MUST be blocked until these conditions are met.
</enforcement>